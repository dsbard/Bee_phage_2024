...
phage_df_norm = readRDS("/Users/dinosbardellati/Desktop/PhD_stuff/projects/Bee_phage/5kb/reviewer_comments/coverM_redo/output_files/5kb_phage_normalized.RDS")
...
# (Intercept)               1.9565     0.1654  5.9324  11.826  2.4e-05 ***
# BeeHoney bee              0.5063     0.2340  5.9324   2.164  0.07417 .  
# TypeVirome               -0.6799     0.2839 16.0000  -2.395  0.02922 *  
# BeeHoney bee:TypeVirome   2.0427     0.4015 16.0000   5.088  0.00011 ***

rich_model = lmer(n_phage ~ Bee*Type + (1|Hive_ID), data = meta_clean_new)
summary(rich_model)

# (Intercept)               16.000      3.385  20.000   4.726 0.000129 ***
# BeeHoney bee               3.556      4.728  20.000   0.752 0.460838    
# TypeVirome                -5.667      6.687  20.000  -0.847 0.406791    
# BeeHoney bee:TypeVirome  181.111      9.457  20.000  19.151 2.47e-14 ***
``` 
...
# Bee       1   2.0790 0.20955 7.3877  3e-04 ***
# Type      1   1.1068 0.11157 3.9332  3e-04 ***
# Bee:Type  1   1.1070 0.11158 3.9336  3e-04 ***
# Residual 20   5.6282 0.56730                  
# Total    23   9.9209 1.00000          
```
...
pdf(file = "/Users/dinosbardellati/Desktop/PhD_stuff/projects/Bee_phage/5kb/reviewer_comments/coverM_redo/output_files/alpha_beta.pdf", width = 25, height = 20)
final
dev.off()
```